/*
 * drivers/staging/android/ion/ion_unmaped_heap.c
 *
...
static int ion_unmapped_heap_phys(struct ion_heap *heap,
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4,9,0))
	.phys = ion_unmapped_heap_phys,
	.map_dma = ion_unmapped_heap_map_dma,
	.unmap_dma = ion_unmapped_heap_unmap_dma,
#endif
